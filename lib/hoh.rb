...
# Is there a more effective method/approach to build nested hash of hash? I
# avoided using literals, but the above feels very ineffective when dealing
# with larger nodes. I wonder what kind of algorithm would be used in
# businesses reliant on big data.